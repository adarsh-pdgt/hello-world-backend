"""Django settings for Hello World project.
...
APPS_DIR = ROOT_DIR.path("hello_world")
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    "DEFAULT_PAGINATION_CLASS": "hello_world.base.api.pagination.PageNumberPagination",
    "PAGE_SIZE": 30,
    # Default renderer classes for Rest framework
    "DEFAULT_RENDERER_CLASSES": [
        "hello_world.base.renderers.HelloWorldApiRenderer",
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "hello_world.users.auth.backends.KnoxTokenLastActiveBackend",
    ],
    "DEFAULT_SCHEMA_CLASS": "rest_framework.schemas.coreapi.AutoSchema",
    "EXCEPTION_HANDLER": "hello_world.base.exceptions.exception_handler",
}
...
SITE_NAME = env("SITE_NAME", default="Hello World")
...
FRONTEND_SITE_NAME = env("FRONTEND_SITE_NAME", default="Hello World")
...
DEFAULT_FROM_EMAIL = env(
    "DEFAULT_FROM_EMAIL", default="Hello World <support@hello_world.com>"
)
EMAIL_SUBJECT_PREFIX = env("EMAIL_SUBJECT_PREFIX", default="[Hello World] ")
...
DATABASES = {"default": env.db("DATABASE_URL", default="postgres:///hello_world")}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                "hello_world.base.context_processors.site_settings",
...
CSRF_FAILURE_VIEW = "hello_world.base.views.csrf_failure"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "hello_world": {"handlers": ["console"], "level": "INFO", "propagate": False},
