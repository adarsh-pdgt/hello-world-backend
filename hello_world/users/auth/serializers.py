...
# Hello World Stuff
from hello_world.users import services as user_services
from hello_world.users.models import UserManager
from hello_world.users.serializers import UserSerializer
...
class AuthUserSerializer(UserSerializer):
    ...
    def get_auth_token(self, user):
        # Auth token manager's create method returns both instance and token.
